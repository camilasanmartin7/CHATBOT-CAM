...
st.set_page_config(page_title="Chatbot de Cam", page_icon="🤖")
...
# python -m streamlit run CHATBOTCAM.py (aca deben ingresar el nombre del archivo)
